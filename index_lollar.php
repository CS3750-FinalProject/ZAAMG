      ...
      <div class='container-fluid'>
        ...
        <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
              <ul class='nav navbar-nav'>
                    <li id='navbar_sec' class='pointer active'>
                        <a  onclick='changePage(this)'>Section <span class='sr-only'>(current)</span></a>
                    </li>
                    <li id='navbar_prof' class='pointer'>
                        <a onclick='changePage(this)'>Professor</a>
                    </li>
                    <li id='navbar_room' class='pointer'>
                        <a onclick='changePage(this)'>Classroom</a>
                    </li>
              </ul>
              ...
              <ul class='nav navbar-nav navbar-right'>
                  <li class='dropdown'>
                        ...
                        aria-haspopup='true' aria-expanded='true' id='createNew'>Create New
            ...
            <li class='dropdown'>
                <a href='#' class='dropdown-toggle' data-toggle='dropdown' role='button'
                    aria-haspopup='true' aria-expanded='true' id='edit'>Edit
                    <span class='caret'></span></a>
              <ul class='dropdown-menu'>
